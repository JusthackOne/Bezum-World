...
@Module({ imports: [PrismaModule, QueueModule, BullModule.registerQueue({ name: BOSS_BATTLES_QUEUE }), AuthModule], controllers: [BossBattlesController, AdminBossBattlesController], providers: [BossBattlesService, BossBattlesRepository, BossBattlesProcessor] })
