...
import { ACTIVATE_JOB, BOSS_BATTLES_QUEUE, EXPIRE_JOB, FINALIZE_JOB } from './boss-battles.constants';
...
export class BossBattlesProcessor extends WorkerHost {
  constructor(private readonly service: BossBattlesService) { super(); }
